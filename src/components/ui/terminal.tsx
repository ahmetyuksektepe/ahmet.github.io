...
export const AnimatedSpan = ({
  ...
  }, [sequence, hasStarted, itemIndex, delay])
...
export const Terminal = ({
  ...
  const totalChildren = useMemo(() => Children.count(children), [children])

  useEffect(() => {
    if (sequence && sequenceHasStarted && activeIndex === totalChildren && onComplete) {
      onComplete();
    }
  }, [activeIndex, totalChildren, sequence, sequenceHasStarted, onComplete])
